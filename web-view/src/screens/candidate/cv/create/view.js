  ...
  submitCV = () => {
    ...
    validateFieldsAndScroll((errors, value) => {
      if (!errors) {
        ...
        const {
          candidateCV: { experiences, qualifications, foreignLanguages },
        } = this.props;
          ...
          <div className="section detail-desc">
            <div className="container white-shadow">
                ...
                <Form className="form" onSubmit={this.onSubmit}>
                      ...
                      <FormItem hasFeedback>
                        {getFieldDecorator('desiredLocation', {
                          rules: [
                            {
                              required: true,
                              message: 'Vị trí mong muốn không được trống!',
                            },
                            {
                              min: 4,
                              message:
                                'Vị trí mong muốn phải lớn hơn hoặc bằng 5 ký tự',
                            },
                          ],
                        })(<Input
                      ...
                      <FormItem hasFeedback>
                        {getFieldDecorator('currentRank', {
                          rules: [
                            {
                              required: true,
                              message: 'Cấp bậc hiên tại không được trống!',
                            },
                          ],
                        })(<Select
                      ...
                      <FormItem hasFeedback>
                        {getFieldDecorator('desiredRank', {
                          rules: [
                            {
                              required: true,
                              message: 'Cấp bậc mong muốn không được trống!',
                            },
                          ],
                        })(<Select
                          optionFilterProp="children"
                      ...
                      <FormItem hasFeedback>
                        {getFieldDecorator('desiredCareer', {
                          rules: [
                            {
                              required: true,
                              message: 'Ngành nghề mong muốn không được trống!',
                            },
                          ],
                        })(<Select
                          optionFilterProp="children"
                      ...
                      <FormItem hasFeedback>
                        {getFieldDecorator('minimumWage', {
                          rules: [
                            {
                              required: true,
                              message: 'Mức lương mong muốn không được trống!',
                            },
                            {
                              pattern: AppConst.regex.positiveInteger,
                              message:
                                'Mong muốn mức lương tối thiểu phải là số nguyên',
                            },
                          ],
                        })(<Input
                          type="number"
                          ...
                          rules: [
                            {
                              required: true,
                              message:
                                'Tổng số năm kinh nghiệm không được trống!',
                            },
                          ],
                        })(<Select
                          optionFilterProp="children"
                      ...
                      <FormItem hasFeedback>
                        {getFieldDecorator('workMode', {
                          rules: [
                            {
                              required: true,
                              message: 'Hình thức làm việc không được trống!',
                            },
                          ],
                        })(<Select
                          optionFilterProp="children"
                      ...
                      <FormItem hasFeedback>
                        {getFieldDecorator('desiredCity', {
                          rules: [
                            {
                              required: true,
                              message: 'Địa điểm mong muốn không được trống!',
                            },
                          ],
                        })(<Select
                          optionFilterProp="children"
                  ...
                  <Row type="flex" justify="space-around">
                    <Col xs={23} sm={23} md={23} lg={23} xl={23}>
                      <Form.Item className="last-form-item" hasFeedback>
                        <BraftEditor
                          value={careerGoal}
                          ref={this.editorInstance}
                          onChange={value =>
                            this.onChangeEditor(value, 'careerGoal')
                          }
                          ...
                          stripPastedStyles
                        />
                        <span className="note-target">
                          Hãy mô tả ngắn gọn về công việc mong muốn của bạn, lý
                          do bạn muốn làm công việc này, những mục tiêu và kế
                          hoạch liên quan tới công việc trong thời gian tới.
                        </span>
                      </Form.Item>
                    </Col>
                    <Col xs={23} sm={23} md={23} lg={23} xl={23}>
                          ...
                          rules: [
                            {
                              required: true,
                              message:
                                'Trình độ học vấn cao nhất không được trống!',
                            },
                          ],
                        })(<RadioGroup>
                  ...
                  <LanguageForm candidateCV={candidateCV} dispatch={dispatch} />
                  <br />
                  <ForteSkillForm
                    dispatch={dispatch}
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <Button type="primary" onClick={this.submitCV}>
                  Tạo hồ sơ
                </Button>
              </div>
              <br />
...
export default connect(({ loading, candidateCV }) => ({
  loading,
  candidateCV,
}))(translate([])(WrappedCVCreateForm));
