...
import { Layout, Row, Form, Col, Input, Select, Button, DatePicker, Upload, Icon } from 'antd'
...
class CVFormCreateView extends React.Component {
  ...
  render() {
    const { form: { getFieldDecorator }, recuitermentCreate: { careerGroups, cover } } = this.props
