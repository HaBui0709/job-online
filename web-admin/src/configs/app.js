...
const LocalStoragePrefix = (process.env.NODE_ENV === 'production') ? 'job-online-admin-' : 'job-online-admin-dev-'

export default {
  name: 'Job online admin',
  ...
  statisticChart: {
    ...
    rangeTitle: 'Thời gian',
    filter: {
      week: 'week',
      day: 'day',
      default: 'week',
      title: 'Lọc theo (Ngày/Tuần)',
      list: [
        {
          _id: 'day',
          name: 'Theo ngày',
